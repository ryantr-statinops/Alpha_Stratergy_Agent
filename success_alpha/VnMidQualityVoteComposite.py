"""
name:    VnMidQualityVoteComposite
summary: Long mid caps when a majority of balance-sheet quality signals agree.
idea:    Four independent quality signals vote on each name: retained earnings
         compounding within equity, other receivables lean vs assets, prompt
         state-budget tax settlement, and low dependence on non-core income.
         Research shows combining uncorrelated signals lifts risk-adjusted
         return over any single one. Half size on a single vote, full size when
