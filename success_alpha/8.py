...
idea:    Bollinger squeeze reversal: trade when price touches outer band during/after squeeze + bb_width expanding + ADX confirming exit via ATR stop; no CMF needed.
"""
