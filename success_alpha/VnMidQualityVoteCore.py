"""
name:    VnMidQualityVoteCore
summary: Long mid caps on a three-signal quality core.
idea:    A trimmed quality vote of the three strongest balance-sheet signals:
         retained earnings compounding within equity, other receivables lean vs
         assets, and prompt state-budget tax settlement. Full size when any two
         agree, half size on a single vote, exit on the trend break.
"""
...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        votes_any = vote_retention | vote_orec | vote_tax
