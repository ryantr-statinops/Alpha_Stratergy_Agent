...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        short_setup = at_resistance & tight_range & (volume > vol_sma) & (adx_val > 18) & (return_roll < 0)
        long_setup = at_support & tight_range & (volume > vol_sma) & (adx_val > 18) & (return_roll > 0)
        exit_setup = (adx_val < 15) | (return_roll < -0.001) | (return_roll > 0.001) | (natr_val > natr_sma * 2.0)
