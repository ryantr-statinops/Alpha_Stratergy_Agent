...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        mom = self.feat.roc(close, timeperiod=5)
        ...
        long_setup = (composite > 4.0) & (volume > vol_sma) & (adx_val > 22) & (return_roll > 0)
        short_setup = (composite < -4.0) & (volume > vol_sma) & (adx_val > 22) & (return_roll < 0)
