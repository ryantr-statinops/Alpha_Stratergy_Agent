class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = (close > midprice) & (roc > 0) & (adx > 22) & (return_roll > 0) & (volume > vol_sma)
        short_setup = (close < midprice) & (roc < 0) & (adx > 22) & (return_roll < 0) & (volume > vol_sma)
        exit_setup = self.op.crossed(close, midprice) | self.op.crossed(roc, 0) | (adx < 18)
