class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = (close > ht_trendline) & (roc > 0) & (adx > 22) & (return_roll > 0)
        short_setup = (close < ht_trendline) & (roc < 0) & (adx > 22) & (return_roll < 0)
        exit_setup = self.op.crossed(close, ht_trendline) | (adx < 18)
