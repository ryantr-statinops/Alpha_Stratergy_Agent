class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        stddev_sma = self.feat.sma(stddev, timeperiod=10)
        ...
        long_setup = (stddev > stddev_sma) & (adx > 22) & (return_roll > 0)
        short_setup = (stddev > stddev_sma) & (adx > 22) & (return_roll < 0)
        exit_setup = (stddev < stddev_sma) | (adx < 18)
