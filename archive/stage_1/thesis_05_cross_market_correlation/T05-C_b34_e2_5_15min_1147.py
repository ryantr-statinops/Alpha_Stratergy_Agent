...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = (basis_z < -2.5) & (matched_vol < vol_sma) & (adx_val > 22)
        short_setup = (basis_z > 2.5) & (matched_vol < vol_sma) & (adx_val > 22)
        exit_setup = self.op.between(basis_z, -1, 1) | (adx_val < 15)
