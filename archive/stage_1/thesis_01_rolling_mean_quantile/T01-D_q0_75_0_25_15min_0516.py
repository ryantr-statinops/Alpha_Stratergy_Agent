...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        upper = self.feat.rolling_quantile(close, window=self.q_window, q=0.75)
        lower = self.feat.rolling_quantile(close, window=self.q_window, q=0.25)
