"""
name:    T12-A
summary: KF Dip/Rally
idea:    Kalman proxy (SMA+residual) regime detection; trend-follow when KF deviates above entry band, mean-revert within band; exit via KF z-cross + ADX fade + ATR stop.
"""
