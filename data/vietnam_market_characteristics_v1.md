# Vietnam Market Characteristics — Strategy Design Guide (v1 — LEGACY)

> **⚠️ LEGACY (vòng 1 — VN30F1M futures intraday).** Không dùng cho Round 2.
> Nội dung viết cho thị trường phái sinh VN30F1M (intraday, session gating, ADX,
> return_roll). Round 2 dùng `data/vietnam_market_characteristics.md` (bản mới,
