...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        strong_long = (composite > 3.0) & (adx_val > 18) & (rsi > 40) & (return_roll > 0)
        weak_long = (composite > 3.0) & (adx_val > 15) & (return_roll > 0)
        strong_short = (composite < -3.0) & (adx_val > 18) & (rsi < 60) & (return_roll < 0)
        weak_short = (composite < -3.0) & (adx_val > 15) & (return_roll < 0)
