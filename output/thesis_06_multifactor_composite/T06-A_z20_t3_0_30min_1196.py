...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        strong_long = core_long & rsi_ok & (adx_val > 18) & (vol_z > 0) & (return_roll > 0)
        weak_long = core_long & rsi_ok & (adx_val > 15) & (return_roll > 0)
        strong_short = core_short & rsi_ok & (adx_val > 18) & (vol_z < 0) & (return_roll < 0)
        weak_short = core_short & rsi_ok & (adx_val > 15) & (return_roll < 0)
