"""
name:    T06-B_z20_t3.0
summary: 4-Factor Z-Score Composite
idea:    Extended composite adding volatility and cross-market ratio z-scores for broader signal coverage.
"""
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        strong_long = core_long & (adx_val > 18) & (vol_z > 0) & (return_roll > 0)
        weak_long = core_long & (adx_val > 15) & (return_roll > 0)
        strong_short = core_short & (adx_val > 18) & (vol_z < 0) & (return_roll < 0)
        weak_short = core_short & (adx_val > 15) & (return_roll < 0)

        exit_setup = (self.op.abs(composite) < 1.0) | (adx_val < 12)
