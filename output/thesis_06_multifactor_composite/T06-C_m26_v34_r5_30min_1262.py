...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        vn30_roc = self.feat.roc(vn30_close, timeperiod=5)
        vn30_ok = vn30_roc > 0
        ...
        strong_long = core_long & volume_ok & atr_trend & (adx_val > 18) & (return_roll > 0)
        weak_long = core_long & (adx_val > 15) & (return_roll > 0)
        strong_short = core_short & volume_ok & atr_trend & (adx_val > 18) & (return_roll < 0)
        weak_short = core_short & (adx_val > 15) & (return_roll < 0)

        exit_setup = self.op.crossed_below(close, ema) | (adx_val < 12)
