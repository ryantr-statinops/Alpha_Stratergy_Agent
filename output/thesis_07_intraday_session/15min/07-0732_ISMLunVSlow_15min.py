...
"""
name:    ISMLunVSlow_15min
summary: Lunch Rev: LunchRev(30) — 15min
...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = (((rsi < 30) & (close < (mid_price - extreme_band))) & (return_roll > 0)) & (adx > self.adx_entry_threshold)
        short_setup = (((rsi > 70) & (close > (mid_price + extreme_band))) & (return_roll < 0)) & (adx > self.adx_entry_threshold)
