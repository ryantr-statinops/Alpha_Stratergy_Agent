...
"""
name:    ISMClsXUltra_15min
summary: Close Sq: CloseSqz(3) — 15min
...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = ((squeeze) & (return_roll > 0)) & (adx > 22)
        short_setup = (((rsi < 50) & (rsi > 30) & (roc < 0) & (volume > vol_sma)) & (return_roll < 0)) & (adx > 22)
        exit_setup = ((self.op.crossed_below(rsi, 50) | self.op.crossed_above(rsi, 50)) | (abs(return_roll) < self.return_threshold)) | (adx < 15)
