...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = (shadow_composite > 3.0) & (volume > vol_ma) & (adx_val > 16) & (return_roll > 0)
        short_setup = (shadow_composite < -3.0) & (volume > vol_ma) & (adx_val > 16) & (return_roll < 0)
        exit_setup = (self.op.abs(shadow_composite) < 0.5) | (adx_val < 10)
