...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = institutional_activity & (roc_val > 0) & (volume > vol_ma) & (adx_val > 14) & (return_roll > 0)
        short_setup = institutional_activity & (roc_val < 0) & (volume > vol_ma) & (adx_val > 14) & (return_roll < 0)
        exit_setup = (agree_z < 0.5) | (adx_val < 10)
