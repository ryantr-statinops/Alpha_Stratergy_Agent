...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = at_support & absorption & (adx_val > 15) & (return_roll > 0)
        short_setup = at_resistance & absorption & (adx_val > 15) & (return_roll < 0)
        exit_setup = (vol_ratio < 1.0) | (adx_val < 12) | (return_roll == 0)
