...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        mom = self.feat.roc(close, timeperiod=14)
        ...
        long_setup = (composite > 2.0) & (volume > vol_sma) & (adx_val > 16) & (return_roll > 0)
        short_setup = (composite < -2.0) & (volume > vol_sma) & (adx_val > 16) & (return_roll < 0)
