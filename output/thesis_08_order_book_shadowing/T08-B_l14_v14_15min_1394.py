...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        short_setup = at_resistance & vol_spike & tight_range & close_lower_half & (adx_val > 18) & (return_roll < 0)
        long_setup = at_support & vol_spike & tight_range & close_upper_half & (adx_val > 18) & (return_roll > 0)
        exit_setup = (adx_val < 15) | (return_roll < -0.001) | (return_roll > 0.001) | (natr_val > natr_ma * 2.0)
