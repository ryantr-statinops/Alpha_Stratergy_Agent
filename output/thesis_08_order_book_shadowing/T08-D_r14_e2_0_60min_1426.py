...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        large_lots = ratio_z > 2.0

        long_setup = large_lots & (premium_z > 0) & (volume > vol_ma) & (adx_val > 14) & (return_roll > 0)
        short_setup = large_lots & (premium_z < 0) & (volume > vol_ma) & (adx_val > 14) & (return_roll < 0)
        exit_setup = (ratio_z < 0) | (adx_val < 10)
