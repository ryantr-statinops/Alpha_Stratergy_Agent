...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        short_setup = over_extended_short & (volume > vol_sma) & (adx_val > 14) & (return_roll < 0)
        long_setup = over_extended_long & (volume > vol_sma) & (adx_val > 14) & (return_roll > 0)
        exit_setup = (self.op.between(close, vwap_val * 0.999, vwap_val * 1.001)) | (adx_val < 10)
