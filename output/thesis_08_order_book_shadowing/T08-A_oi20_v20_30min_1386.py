...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = at_support & oi_collapse & (volume > vol_sma) & (adx_val > 15)
        short_setup = at_resistance & oi_collapse & (volume > vol_sma) & (adx_val > 15)
        exit_setup = (oi_z > 0) | (adx_val < 12)
