...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = large_lots & (premium_z > 0) & (volume > vol_ma) & (adx_val > 15) & (return_roll > 0)
        short_setup = large_lots & (premium_z < 0) & (volume > vol_ma) & (adx_val > 15) & (return_roll < 0)
        exit_setup = (ratio_z < 0) | (adx_val < 12)
