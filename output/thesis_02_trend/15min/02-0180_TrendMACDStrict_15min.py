...
"""
name:    TrendMACDStrict_15min
summary: MACD: MACD + ADX(25) — 15min
thesis:  trend | 15min
...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        exit_setup = (self.op.crossed_below(macd_line, signal_line) | self.op.crossed_above(macd_line, signal_line)) | self.op.crossed_below(abs(return_roll), self.return_threshold)
