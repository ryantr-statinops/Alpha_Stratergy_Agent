...
"""
name:    TrendQQSlow_15min
summary: Quantile Trend: Q75/Q25 slow + ADX — 15min
thesis:  trend | 15min
idea:    Slow quantile trend
"""
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        exit_setup = (self.op.crossed_below(close, upper) | self.op.crossed_above(close, lower)) | self.op.crossed_below(abs(return_roll), self.return_threshold) | trailing_long_exit | trailing_short_exit
