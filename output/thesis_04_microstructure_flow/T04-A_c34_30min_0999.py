...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = buying_pressure & (adx_val > 18) & (volume > vol_sma)
        short_setup = selling_pressure & (adx_val > 18) & (volume > vol_sma)
        exit_setup = self.op.crossed_below(cmf, 0) | self.op.crossed_above(cmf, 0) | (adx_val < 12)
