...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = smart_money_long & (close > close_sma) & (adx_val > 18)
        short_setup = smart_money_short & (close < close_sma) & (adx_val > 18)
        exit_setup = self.op.crossed_below(close, close_sma) | self.op.crossed_above(close, close_sma) | (adx_val < 12)
