"""
name:    T04-D_w20_s2.0
summary: Whale Footprint
idea:    Detect institutional activity via avg trade size deviation; trade compression-breakout with whale presence.
"""
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        whale = avg_trade > avg_trade_sma + 2.0 * avg_trade_std
        ...
        long_setup = whale & price_compression & (matched_vol > vol_sma * 1.5) & (adx_val > 18)
        short_setup = whale & price_compression & (matched_vol > vol_sma * 1.5) & (adx_val > 18)
        exit_setup = self.op.crossed_below(close, self.feat.sma(close, 20)) | self.op.crossed_above(close, self.feat.sma(close, 20)) | (adx_val < 12)
