...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = (close > close_sma) & (obv > obv_sma) & (adx_val > 18)
        short_setup = (close < close_sma) & (obv < obv_sma) & (adx_val > 18)
        exit_setup = self.op.crossed_below(obv, obv_sma) | self.op.crossed_above(obv, obv_sma) | (adx_val < 12)
