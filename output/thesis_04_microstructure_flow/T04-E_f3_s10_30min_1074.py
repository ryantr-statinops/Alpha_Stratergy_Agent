...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = bullish_div & (adx_val > 18)
        short_setup = bearish_div & (adx_val > 18)
        exit_setup = self.op.crossed_below(close, self.feat.sma(close, 14)) | self.op.crossed_above(close, self.feat.sma(close, 14)) | (adx_val < 12)
