...
"""
name:    MRBBXExtreme_60min
summary: BBands Rev: BBands(4STD) — 60min
...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        exit_setup = ((self.op.crossed_above(close, mid_band) | self.op.crossed_below(close, mid_band)) | self.op.crossed_below(abs(return_roll), self.return_threshold)) | self.op.crossed_below(adx, self.adx_exit_threshold)
