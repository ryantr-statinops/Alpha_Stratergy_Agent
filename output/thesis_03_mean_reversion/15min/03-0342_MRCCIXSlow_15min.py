...
"""
name:    MRCCIXSlow_15min
summary: CCI: CCI(52) — 15min
...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        exit_setup = ((self.op.crossed_above(cci, 0) | self.op.crossed_below(cci, 0)) | self.op.crossed_below(abs(return_roll), self.return_threshold)) | self.op.crossed_below(adx, self.adx_exit_threshold) | trailing_long_exit | trailing_short_exit
