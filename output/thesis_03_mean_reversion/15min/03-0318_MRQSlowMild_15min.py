...
"""
name:    MRQSlowMild_15min
summary: Quantile Rev: Q85%/Q15%(34) — 15min
...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        exit_setup = ((self.op.crossed_above(close, lower) | self.op.crossed_below(close, upper)) | self.op.crossed_below(abs(return_roll), self.return_threshold)) | self.op.crossed_below(adx, self.adx_exit_threshold) | trailing_long_exit | trailing_short_exit
