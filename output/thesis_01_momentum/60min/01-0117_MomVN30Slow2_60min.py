...
"""
name:    MomVN30Slow2_60min
summary: Momentum+VN30: ROC(slow) + VN30 slow — 60min
thesis:  momentum | 60min
idea:    Slow momentum + VN30 alignment
"""
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        exit_setup = ((self.op.crossed_below(roc_fut, 0) | self.op.crossed_above(roc_fut, 0)) | self.op.crossed_below(abs(return_roll), self.return_threshold)) | self.op.crossed_below(adx, self.adx_exit_threshold) | trailing_long_exit | trailing_short_exit
