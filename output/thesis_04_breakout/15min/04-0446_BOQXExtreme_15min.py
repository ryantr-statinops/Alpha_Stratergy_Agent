...
"""
name:    BOQXExtreme_15min
summary: Quantile BO: Q95%(13) + volume — 15min
...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        exit_setup = ((self.op.crossed_below(close, upper) | self.op.crossed_above(close, lower)) | self.op.crossed_below(abs(return_roll), self.return_threshold)) | self.op.crossed_below(adx, self.adx_exit_threshold) | trailing_long_exit | trailing_short_exit
