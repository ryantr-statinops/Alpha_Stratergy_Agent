...
"""
name:    VFOIVSlow_30min
summary: OI Trend: OI(68) — 30min
...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        exit_setup = (((oi < oi_sma) | self.op.crossed_below(close, close_sma)) | self.op.crossed_below(abs(return_roll), self.return_threshold)) | self.op.crossed_below(adx, self.adx_exit_threshold)
