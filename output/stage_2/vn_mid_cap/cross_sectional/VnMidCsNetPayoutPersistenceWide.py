"""
name:    VnMidCsNetPayoutPersistenceWide
summary: Allocate across mid caps by persistent net payout yield: dividends
         ...
         by market value, without a buyback gate. Market-neutral
...
idea:    Dividends and buybacks are substitutes; subtracting issuance measures
         ...
         is a positive inflow. The strict buyback gate is dropped because most
         mid caps never report a buyback field, and a missing buyback should be
         unavailable, not excluded. Widening eligibility keeps non-buyback
         payers in the cross-section and reduces Test-window sparsity.
"""
...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        eligible = (input_sum == input_sum) & (dividends < 0) & (common_shares > 0) & (close > 0) & (market_value > 0)
