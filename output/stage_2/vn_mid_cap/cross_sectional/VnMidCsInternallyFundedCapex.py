"""
name:    VnMidCsInternallyFundedCapex
summary: Allocate across mid caps by how much capex is funded internally from
...
idea:    Capital expenditure covered by operating cash flow reduces dependence
         ...
         minus borrowings and issuance. mid caps that self-fund investment
