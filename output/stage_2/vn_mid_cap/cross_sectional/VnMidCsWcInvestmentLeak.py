"""
name:    VnMidCsWcInvestmentLeak
summary: Buy mid caps with low investment flows relative to working capital
         while the uptrend holds. Capital-discipline vote plus trend vote.
         Covers pair H+N: investments in others vs working capital.
idea:    H+N pair #90 - Receivables from investments. Low
         investments_in_other_entities/working_capital means capital is not
         leaking into non-core investments at the expense of working-capital
         efficiency. Investments in others is a nonpositive outflow, so the
         ratio uses its negated value.
"""
