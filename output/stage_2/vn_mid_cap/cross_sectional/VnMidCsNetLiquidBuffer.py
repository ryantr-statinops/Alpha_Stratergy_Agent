"""
name:    VnMidCsNetLiquidBuffer
summary: Allocate across mid caps by net liquid-asset buffer: cash plus
...
idea:    Liquid assets above interest-bearing debt reduce refinancing downside
         ...
         defensive state that protects mid caps through systemic shocks like
