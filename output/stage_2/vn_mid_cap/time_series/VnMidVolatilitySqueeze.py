"""
name:    VnMidVolatilitySqueeze
summary: Long mid caps after a Bollinger squeeze resolves to the upside.
idea:    Mid-cap accumulation compresses the Bollinger band width to an extreme
         low percentile before a volatility breakout. Entry requires the band
         width to stay squeezed for three bars and then price to close above
         the upper band with volume confirmation. Exit when price returns below
         the band middle or loses the slow average.
"""
