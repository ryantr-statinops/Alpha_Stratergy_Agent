"""
name:    VnSmallCsReceivablesDeterioration
summary: Receivables-quality gate on the validated value-trend return engine.
idea:    The independent receivables factor acts as a gate on the validated
...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        ratio = self.feat.safe_divide_panel(receivables, total_assets)
        ...
        base_eligible = (
            ...
            & (capital_strength > 0.15) & (receivables >= 0) & (total_assets > 0)
