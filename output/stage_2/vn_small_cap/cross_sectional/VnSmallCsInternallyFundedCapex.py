"""
name:    VnSmallCsInternallyFundedCapex
summary: Allocate across small caps by how much capex is funded internally from
...
idea:    Capital expenditure covered by operating cash flow reduces dependence
         ...
         minus borrowings and issuance. small caps that self-fund investment
