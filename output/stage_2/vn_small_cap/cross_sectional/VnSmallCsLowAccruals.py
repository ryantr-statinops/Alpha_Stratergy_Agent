"""
name:    VnSmallCsLowAccruals
summary: Low-accrual gate on the validated value-trend return engine.
idea:    The independent accrual-quality factor acts as a gate on the validated
...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        eligible = base_eligible & (liquidity_rank > 0.40) & (accrual_quality > 0)
