"""
name:    VnSmallCsLowAmihud
summary: Low-Amihud gate on the validated value-trend return engine.
idea:    The independent Amihud factor acts as a gate on the validated
...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        eligible = (
            base_eligible & (liquidity_rank > 0.40) & (illiquidity_rank < 0.70)
        )
