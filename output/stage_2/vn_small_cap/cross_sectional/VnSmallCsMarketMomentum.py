"""
name:    VnSmallCsMarketMomentum
summary: Relative price momentum tilt on the validated value-trend return engine.
idea:    Cross-sectional relative price momentum tilts the
...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        momentum = self.feat.rolling_mean_panel(self.feat.returns_panel(close))
        base_eligible = (
        ...
        momentum_rank = self.op.rank_cs_panel(momentum, mask=base_eligible)
