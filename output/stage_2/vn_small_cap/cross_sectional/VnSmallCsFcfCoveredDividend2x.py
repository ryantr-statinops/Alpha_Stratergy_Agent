"""
name:    VnSmallCsFcfCoveredDividend2x
summary: Allocate across small caps by dividend yield gated by free cash flow
         covering the dividend, with 2.0x gross sizing. Market-neutral
...
idea:    A standalone dividend yield is often a value trap. A yield is durable
         ...
         A unit-gross book caps absolute return, so this ablation scales the
         weights by 2.0 (position-sizing layer only); the rank order and the
         market-neutral construction are unchanged.
"""
