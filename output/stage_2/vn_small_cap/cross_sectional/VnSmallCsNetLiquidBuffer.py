"""
name:    VnSmallCsNetLiquidBuffer
summary: Allocate across small caps by net liquid-asset buffer: cash plus
...
idea:    Liquid assets above interest-bearing debt reduce refinancing downside
         ...
         defensive state that protects small caps through systemic shocks like
