"""
name:    VnSmallCsCostDiscipline
summary: Cost-discipline rank tilt on the validated value-trend return engine.
idea:    Lean selling + G&A expense relative to assets signals operating
         discipline and scale efficiency in small caps. Lower cost burden tilts
         the validated earnings-yield x trend core toward efficient operators.
"""
...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        cost_burden = self.feat.safe_divide_panel(selling + admin, total_assets_q)
        ...
        cost_rank = self.op.rank_cs_panel(cost_burden, mask=base_eligible)
        lean_tilt = 1.5 - cost_rank
