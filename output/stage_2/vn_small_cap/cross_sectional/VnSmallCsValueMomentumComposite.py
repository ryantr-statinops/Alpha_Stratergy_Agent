"""
name:    VnSmallCsValueMomentumComposite
summary: Buy small caps that are cheap on quarterly earnings yield, financially
...
idea:    The momentum term (close/ema) squared is the dominant driver and is a
         ...
         quarterly; no cash-flow fields, so coverage stays broad.
"""
