"""
name:    VnSmallCsWorkingCapitalLoanSafety
summary: Working-capital-loan-safety rank tilt on the validated value-trend engine.
idea:    A cash buffer against short-term loans protects small caps from
         rollover shocks and forced liquidation. Higher cash/short-term-loan
         coverage tilts the validated earnings-yield x trend core toward names
         with safer short-term funding.
"""
...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        loan_coverage = self.feat.safe_divide_panel(cash, short_loans)
        ...
        base_eligible = (
            ...
            & (capital_strength > 0.15) & (cash >= 0) & (short_loans > 0)
        )
        ...
        coverage_rank = self.op.rank_cs_panel(loan_coverage, mask=base_eligible)
