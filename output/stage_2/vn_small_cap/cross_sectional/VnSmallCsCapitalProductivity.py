"""
name:    VnSmallCsCapitalProductivity
summary: Capital-productivity rank tilt on the validated value-trend engine.
idea:    Profit per unit of tangible fixed assets measures how efficiently a
         small cap deploys its heavy capital. Higher productivity tilts the
         validated earnings-yield x trend core toward efficient operators.
"""
...
class CustomStrategy(SimpleAlgorithm):
    def __algorithm__(self):
        ...
        productivity = self.feat.safe_divide_panel(net_profit, fixed_assets)
        ...
        base_eligible = (
            ...
            & (capital_strength > 0.15) & (net_profit > 0) & (fixed_assets > 0)
        )
        ...
        productivity_rank = self.op.rank_cs_panel(productivity, mask=base_eligible)
        tilt = 0.9 + productivity_rank * 0.2
