"""
name:    VnLargeCashSpreadSlow
summary: Long large caps with positive cash-earnings spread using slow 14/42
         EMA for lower noise and reduced whipsaw.
idea:    Variant of CashEarningsSpreadTrend with the cash-flow quality
         canonical profile (14/42). Slower timing may reduce the whipsaw
         that erodes Test-period returns while maintaining the fundamental
         cash-quality edge.
"""
