"""
name:    VnLargeCsEarnedToContributed
summary: Allocate across large caps by earned-to-contributed capital: retained
...
idea:    Retained earnings relative to contributed capital reflect the corporate
         ...
         value creation. This is a very slow lifecycle state that is largely
