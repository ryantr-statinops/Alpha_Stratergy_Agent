"""
name:    VnLargeCsFcfCoveredDividendWide
summary: Allocate across large caps by dividend yield gated by positive free
         cash flow, a coverage-widened variant. Market-neutral cross-sectional
         book.
idea:    A standalone dividend yield is often a value trap. This ablation widens
         ...
         looser band keeps more payers in the cross-section, which lifts
         coverage and reduces Test-window sparsity behind the low Test CAGR of
         the parent variant.
"""
