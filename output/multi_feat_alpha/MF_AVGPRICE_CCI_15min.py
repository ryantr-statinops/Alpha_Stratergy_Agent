class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = (close > ema10) & (cci > 0) & (adx > 22) & (return_roll > 0) & (volume > vol_sma)
        short_setup = (close < ema10) & (cci < 0) & (adx > 22) & (return_roll < 0) & (volume > vol_sma)
        exit_setup = self.op.crossed(close, ema10) | self.op.crossed(cci, 0) | (adx < 18)
