class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = (close > ema10) & (rsi > 50) & (adx > 22) & (return_roll > 0) & (atr > 1)
        short_setup = (close < ema10) & (rsi < 50) & (adx > 22) & (return_roll < 0) & (atr > 1)
        exit_setup = self.op.crossed(close, ema10) | self.op.crossed_above_value(rsi, 50) | self.op.crossed_below_value(rsi, 50) | (adx < 18)
