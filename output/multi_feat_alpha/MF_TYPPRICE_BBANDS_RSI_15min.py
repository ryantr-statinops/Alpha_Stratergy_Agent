class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = (close > sma10) & (rsi > 50) & (adx > 22) & (return_roll > 0) & (volume > vol_sma)
        short_setup = (close < sma10) & (rsi < 50) & (adx > 22) & (return_roll < 0) & (volume > vol_sma)
        exit_setup = self.op.crossed(close, sma10) | self.op.crossed_above_value(rsi, 50) | self.op.crossed_below_value(rsi, 50) | (adx < 18)
