...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = (close > ema) & structured & (adx_val > 16)
        short_setup = (close < ema) & structured & (adx_val > 16)
        exit_setup = self.op.crossed_below(close, ema) | self.op.crossed_above(close, ema) | chaotic | (adx_val < 10)
