...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = (slope > 0) & (angle > 5) & (close < forecast) & (adx_val > 18)
        short_setup = (slope < 0) & (angle < -5) & (close > forecast) & (adx_val > 18)
        exit_setup = self.op.crossed_below(slope, 0) | self.op.crossed_above(slope, 0) | (adx_val < 12)
