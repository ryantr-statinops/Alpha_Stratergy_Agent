...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = (close > kama) & (adx_val > 16)
        short_setup = (close < kama) & (adx_val > 16)
        exit_setup = self.op.crossed_below(close, kama) | self.op.crossed_above(close, kama) | (adx_val < 10)
