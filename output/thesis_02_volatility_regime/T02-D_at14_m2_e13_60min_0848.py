...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = (close > ema) & (adx_val > 16) & (close > (close - atr_val * self.atr_mult))
        short_setup = (close < ema) & (adx_val > 16) & (close < (close + atr_val * self.atr_mult))
