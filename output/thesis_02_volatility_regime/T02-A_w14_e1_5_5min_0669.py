...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        vol_expansion = atr_val > atr_sma * 1.5
        roc_val = self.feat.roc(close, timeperiod=3)

        long_setup = vol_expansion & (roc_val > 0) & (adx_val > 22)
        short_setup = vol_expansion & (roc_val < 0) & (adx_val > 22)
        exit_setup = (atr_val < atr_sma) | self.op.crossed_below(adx_val, 15)
