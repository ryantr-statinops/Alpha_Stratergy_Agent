...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = vol_expansion & (roc_val > 0) & (adx_val > 18)
        short_setup = vol_expansion & (roc_val < 0) & (adx_val > 18)
        exit_setup = (atr_val < atr_sma) | self.op.crossed_below(adx_val, 12)
