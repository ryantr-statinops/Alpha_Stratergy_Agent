...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = (((dji_roc > 0) & (fut_roc > 0)) & (return_roll > 0)) & (adx > 22)
        short_setup = (((dji_roc < 0) & (fut_roc < 0)) & (return_roll < 0)) & (adx > 22)
        exit_setup = ((self.op.crossed_below(fut_roc, 0) | self.op.crossed_above(fut_roc, 0)) | (abs(return_roll) < self.return_threshold)) | (adx < 15)
