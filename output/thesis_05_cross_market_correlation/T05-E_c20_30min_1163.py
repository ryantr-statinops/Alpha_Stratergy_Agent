...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        long_setup = correl_aligned & (roc_val > 0) & (adx_val > 18)
        short_setup = correl_aligned & (roc_val < 0) & (adx_val > 18)
        exit_setup = correl_negative | self.op.crossed_below(adx_val, 12)
