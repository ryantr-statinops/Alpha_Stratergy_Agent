...
"""
name:    MFTVXSlow_15min
summary: Trend+Vol: MFTrendVol(52) — 15min
...
class CustomStrategy(SimpleAlgorithm):
    ...
    def __algorithm__(self):
        ...
        exit_setup = (self.op.crossed_below(close, ema) | (adx < 15)) | self.op.crossed_below(abs(return_roll), self.return_threshold) | trailing_long_exit | trailing_short_exit
