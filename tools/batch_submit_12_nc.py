...
files = [
    ...
    "output/niche_alpha/NC_MACDFIX_CROSSOVER_ADX_15min.py",
    "output/niche_alpha/NC_MACD_SIGNAL_ADX_15min.py",
    ...
    "output/niche_alpha/NC_ARGMIN_NEW_LOW_ADX_15min.py",
    "output/niche_alpha/NC_MORNING_EVENING_STAR_ADX_15min.py",
    "output/niche_alpha/NC_PIERCING_DARKCLOUD_ADX_15min.py",
    "output/niche_alpha/NC_ENGULFING_ADX_15min.py",
    "output/niche_alpha/NC_HAMMER_DOJI_REVERSAL_ADX_15min.py",
    "output/niche_alpha/NC_THREE_METHODS_ADX_15min.py",
]
